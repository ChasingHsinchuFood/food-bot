                        ...
                        if($estJson[$estIndex]["Direction"] == 0 && $stopName == $estJson[$estIndex]["StopName"]["Zh_tw"]) {
                            if(isset($estJson[$estIndex]["StopStatus"])) {
                                switch($estJson[$estIndex]["StopStatus"]) {
                                    case 1:
                                        $result["direction_0_stop_name"][$resultZeroIndex]["stop_status"] = "尚未發車";     
                                        break;
                                    case 2:
                                        $result["direction_0_stop_name"][$resultZeroIndex]["stop_status"] = "交管不停靠";
                                        break;
                                    case 3:
                                        $result["direction_0_stop_name"][$resultZeroIndex]["stop_status"] = "末班車已過";
                                        break;
                                    case 4:
                                        $result["direction_0_stop_name"][$resultZeroIndex]["stop_status"] = "今日未營運";
                                        break;
                                }
                            }
                            else {
                                $result["direction_0_stop_name"][$resultZeroIndex]["stop_status"] = "正常發車";
                            }
